export class PatchBookingPayload {
    constructor() {
        this._firstname = "abi";
        this._lastname = "test";
    ...
    build(fieldincluded = null) {
        ...
        for (const field of fieldincluded) {
            if (field in fullpayload) {
                partialPayload[field] = fullpayload[field]
            }
            else {
                console.warn(`⚠️ Field "${field}" not found in payload`);
            }
        }
